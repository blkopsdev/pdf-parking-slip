...
<table class="order-data-addresses">
	<tr>
		...
		<td class="address billing-address packing-slip-doc.">
		...
		<td class="order-data packing-slip-doc">
			<table>
				...
				<?php foreach( $this->get_woocommerce_totals() as $key => $total ) : ?>
					<?php if(!($key == 'cart_subtotal' || $key == 'shipping' || $key == 'payment_method')) { ?>
